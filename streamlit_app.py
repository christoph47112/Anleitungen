...
""" + content[:500]    summary = generator(prompt_summary, max_length=100, num_return_sequences=1)[0]['generated_text']

    # Schritt-für-Schritt-Anleitung erstellen
    prompt_steps = "Schritt-für-Schritt Anleitung:
""" + content[:500]    steps = generator(prompt_steps, max_length=150, num_return_sequences=1)[0]['generated_text']
